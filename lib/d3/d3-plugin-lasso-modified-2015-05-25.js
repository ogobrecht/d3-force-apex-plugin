/***********************************************************************************************************************
 * D3 Lasso Plugin: https://github.com/d3/d3-plugins/blob/master/lasso/lasso.js
 */
...
d3.lasso = function() {
  ...
  function lasso() {
     ...
     * */
    // 
    var g, dyn_path, close_path, complete_path;
  ...
  lasso.pathContainer = function(_) {
    if(!arguments.length) return pathContainer;
